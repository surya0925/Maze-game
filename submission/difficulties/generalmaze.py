...
def gameover(lives,time,completed) :
    if completed:
     ...
     score = lives*3 + time*10+1000
    if not completed:
     pygame.display.set_caption("Game Over")
     score = lives*3 + time*10 
    ...
    while restart:
        ...
        time_text = get_font(40).render("time" ,True,"White")
        ...
        restart_button = Button(image=None, pos=(600,600), text_input="Restart", font=get_font(40), base_color="white", hovering_color="green")
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if restart_button.Checkinput(gameover_mouse_pos):
...
def loop() :
    ...
    background_image = pygame.transform.scale(background_image,(1800,1800))
