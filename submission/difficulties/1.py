...
def gameover(lives,time,completed) :
    ...
    while True:
        ...
        time_text = get_font(40).render("Time Rem " ,True,"White")
        time_rect = time_text.get_rect( center= (350,500))
         #### to find maze is cleared
        time_value_text = get_font(40).render(str(time) ,True,"White")
